...
const DetailsScreen = ({ navigation, route }) => {
  ...
  useEffect(() => {
    var match_id = route.params.match_id;
  ...
  var team1 = route.params.team1;
  //console.log("team 1 : ", team1);
  var team2 = route.params.team2;
  //console.log("team 2 : ", team2);
  var score1 = route.params.score1;
  //console.log("score 1 : ", score1);
  var score2 = route.params.score2;
