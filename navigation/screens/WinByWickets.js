...
export default WinByWickets = ({ route, navigation }) => {
  ...
  const [winwicket, setwinnwicket] = useState('')
  var winwkt, team;
  ...
  const insertData2 = () => {
    ...
    console.log("win by wicket match_id : ", m_id);
    ...
    //incrementing lost count of batting team
    db.transaction((tx) => {
      tx.executeSql(
        'SELECT total_matches,won,lost from teams where team_name = ?',
        [bat],
    ...
    <View style={styles.container}>
      ...
      <View style={styles.cardStyle}>
        ...
        <Text style={styles.paragraph}>
          {teams} won by {winwicket} wickets.
        </Text>
